...
1. Update clore.net with correct popup version

2. Update clore.net with correct release download urls for each platform (Windows, Linux, Mac)

**Build Process**

1. Verify that the release build doesn't say **_dirty_** in the commit message
