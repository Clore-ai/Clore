...
[Clore git repository](https://github.com/clore-ai/clore) but are not part of
...
that _may_ vary by distribution and version of distribution.

The SELinux stuff in this RPM spec file _should_ be correct for CentOS, RHEL,
...
2. He does not build BerkeleyDB but instead uses the BerkeleyDB provided by the
   ...
   use the same version of BerkeleyDB so that difference is _probably_ just
   academic.
