    ...
    while (pcursor->Valid()) {
        ...
        if (pcursor->GetKey(key) && key.first == DB_BLOCK_INDEX) {
            ...
            if (pcursor->GetValue(diskindex)) {
                ...
                // For regtest, skip proof of work check entirely
                if (!consensusParams.fPowNoRetargeting && !CheckProofOfWork(pindexNew->GetBlockHash(), pindexNew->nBits, consensusParams))
