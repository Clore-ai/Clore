...
UniValue createrawtransaction(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            // TODO if we decide to remove the consensus check from issue 675 https://github.com/clore-ai/clore/issues/675
...
// TODO, if we decide to remove the consensus check https://github.com/clore-ai/clore/issues/675, remove or add the code (requires consensus change)
