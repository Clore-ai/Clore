...
Transfer clore-_-win_-unsigned.tar.gz to ~/win64/ from the Ubuntu 18 build machine's ~/sign directory
...
Transfer clore-_-win_-setup.exe back to the Ubuntu18 build machine to the folder ~/release (to shasum with the rest of the releases)
...
Transfer clore-_-win_-unsigned.tar.gz to ~/win32/ from the Ubuntu 18 build machine's ~/sign directory
...
Transfer your _-secret-gpg.key and _-ownertrust-gpg.txt to ~/  
