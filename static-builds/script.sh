...
find ${DISTNAME}/bin -type f -executable -exec ../clore/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../clore/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/clore/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/clore/depends/SDKs/MacOSX10.11.sdk.tar.gz
