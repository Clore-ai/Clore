...
space _do not upload these to the clore.net server, nor put them in the torrent_.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the clore.net server
...
people without access to `clore.net` to download the binary distribution.
Also put it into the `optional_magnetlink:` slot in the YAML file for
clore.net (see below for clore.net update instructions).

- Update clore.net version

  - First, check to see if the Clore.org maintainers have prepared a
    release: https://github.com/clore-dot-org/clore.net/labels/Releases
  ...
  - If they have not prepared a release, follow the Clore.org release
    instructions: https://github.com/clore-dot-org/clore.net#release-notes
